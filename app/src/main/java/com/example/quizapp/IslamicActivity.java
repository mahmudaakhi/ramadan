  ...
  //  private PlayAudioForAnswers playAudioForAnswers;
            ...
            public void onClick(View v) {
                ...
                if (!answerd) {
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked() || rb4.isChecked()) {
                        ...
                        Toast.makeText(IslamicActivity.this, "Please Select the Answer ", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
        ...
        switch (currentQuestions.getAnswerNr()) {
            ...
            case 2:
                if (currentQuestions.getAnswerNr() == answerNr) {
                  ...
                  // WrongDialog.wron(correctAnswer,this);
    ...
    private void updateCountDownText(){
        ...
        if (timeleftinMillis < 10000){
            ...
            textViewCountDown.setTextColor(ContextCompat.getColor(this,R.color.colorPrimary));
    ...
    private void finalResult(){
        ...
        Intent resultData = new Intent(IslamicActivity.this,MainActivity.class);
    ...
    public void onBackPressed() {
        if (backPressedTime + 2000 > System.currentTimeMillis()){
            ...
            Intent intent = new Intent(IslamicActivity.this,MainActivity.class);
